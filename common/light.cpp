...
void Light::update() {
   ...
   // Move across z-axis
    if (glfwGetKey(window, GLFW_KEY_K) == GLFW_PRESS) {
        lightPosition_worldspace += lightSpeed * vec3(0.0, 0.0, 0.1);
     /*   std::cout << "position of light on z axis: " << lightPosition_worldspace.z << endl;
        std::cout << "position of light on x axis: " << lightPosition_worldspace.x << endl;
        std::cout << "position of light on y axis: " << lightPosition_worldspace.y << endl;*/
    }
    ...
    if (glfwGetKey(window, GLFW_KEY_L) == GLFW_PRESS) {
        lightPosition_worldspace += lightSpeed * vec3(0.1, 0.0, 0.0);
    ...
    if (glfwGetKey(window, GLFW_KEY_U) == GLFW_PRESS) {
        lightPosition_worldspace += lightSpeed * vec3(0.0, 0.1, 0.0);
